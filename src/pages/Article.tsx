...
export function Article() {
  ...
  // Generate Facebook share link or post link
  const fbShareUrl = article.facebookUrl 
    ? article.facebookUrl 
  ...
  return (
    <article className="mx-auto max-w-4xl space-y-6 rounded-2xl bg-white p-4 sm:p-8 shadow-[0_10px_30px_rgba(15,23,42,0.05)] border border-slate-100">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4 text-sm">
        ...
        <p className="font-medium text-slate-600">By {article.author.name}</p>
      </div>
      ...
      {/* Share Actions and Related Topics Panel */}
      <div className="space-y-6 border-t border-slate-100 pt-6">
        {/* Facebook Share/View button */}
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            ...
            {article.facebookUrl ? "View Original Post" : "Share on Facebook"}
          </a>
        </div>
